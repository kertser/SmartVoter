...
const en: Translations = {
  ...
  questionnaire: {
    ...
    skipOutdated: "Skip question",
    skipOutdatedTooltip: "Skip if this question refers to a resolved issue or feels irrelevant. It won't appear again in this session.",
    skipping: "Skipping…",
    goBack: "← Previous",
    goBackTooltip: "Return to the previous question and change your answer.",
  ...
  methodology: {
    ...
    adaptiveQuestionnaireHeading: "Adaptive questionnaire",
  ...
  admin: {
    ...
    questionBankGenerateExplanationsLabel: "Generate explanations (EN/HE/RU) for each question (slow, uses LLM per question)",
    ...
    questionBrowserHeading: "📋 Question Browser",
    questionBrowserSubtext: "Browse, edit, delete, and generate explanations for all questions in the database.",
    questionBrowserFilter: "Filter by status",
    questionBrowserFilterAll: "All statuses",
    questionBrowserFilterApproved: "Approved",
    questionBrowserFilterLlmGenerated: "LLM generated",
    questionBrowserFilterNeedsReview: "Needs review",
    questionBrowserFilterRejected: "Rejected",
    questionBrowserFilterDraft: "Draft",
    questionBrowserSearch: "Search questions…",
    questionBrowserCount: (n) => `${n} question(s)`,
    questionBrowserDelete: "Delete",
    questionBrowserDeleteConfirm: "Permanently delete this question? This cannot be undone.",
    questionBrowserDeleteSelected: (n) => `Delete ${n} selected`,
    questionBrowserDeleteSelectedConfirm: (n) => `Permanently delete ${n} selected question(s)? This cannot be undone.`,
    ...
    questionBrowserNoItems: "No questions match the current filter.",
    questionBrowserRootBadge: "root",
    questionBrowserStaleBadge: "stale",
    questionBrowserLoadMore: "Load more",
  },
