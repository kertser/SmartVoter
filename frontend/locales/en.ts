...
const en: Translations = {
  ...
  questionnaire: {
    ...
    skipOutdated: "⏭ Skip — no longer relevant",
    skipOutdatedTooltip: "Skip this question if you think it refers to a resolved issue or is not relevant to the current political situation. It won't appear again in this session.",
    skipping: "Skipping…",
    goBack: "← Go back",
